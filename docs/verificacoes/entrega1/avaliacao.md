...
<font size="3"><p class="table-source"><b>Tabela 1</b> - Artefatos analisados e Participantes Responsáveis </p></font>
...
<font size="3"><p class="table-source"><b>Tabela 2</b> - Cronograma de avaliação dos Artefatos</p></font>
...
<div align="center">
  <p class="table-source"><strong>Figura 1</strong> - Comprovação do Item 01</p>
  
  <img src="../../../assets/images/avaliacoes/avaliacao1/item01.png" alt="Descrição">

  <p class="table-source">Fonte: <a href="#1">(Barbosa et al., 2021, p. 94)</a></p>
</div>
...
<div align="center">
  <p class="table-source"><strong>Figura 2</strong> - Comprovação do Item 02</p>
  
  <img src="../../../assets/images/avaliacoes/avaliacao1/item02.png" alt="Descrição">

  <p class="table-source">Fonte: <a href="#1">(Barbosa et al., 2021, p. 96)</a></p>
</div>
...
<div align="center">
  <p class="table-source"><strong>Figura 3</strong> - Comprovação do Item 03</p>
  
  <img src="../../../assets/images/avaliacoes/avaliacao1/item03.png" alt="Descrição">

  <p class="table-source">Fonte: <a href="#1">(Barbosa et al., 2021, p. 98)</a></p>
</div>
...
<div align="center">
  <p class="table-source"><strong>Figura 4</strong> - Comprovação do Item 04</p>
  
  <img src="../../../assets/images/avaliacoes/avaliacao1/item04.png" alt="Descrição">

  <p class="table-source">Fonte: <a href="#1">(Barbosa et al., 2021, p. 99)</a></p>
</div>
...
<div align="center">
  <p class="table-source"><strong>Figura 5</strong> - Comprovação do Item 05</p>
  
  <img src="../../../assets/images/avaliacoes/avaliacao1/item05.png" alt="Descrição">

  <p class="table-source">Fonte: <a href="#1">(Barbosa et al., 2021, p. 106)</a></p>
</div>
...
<div align="center">
  <p class="table-source"><strong>Figura 6</strong> - Comprovação do Item 06</p>
  
  <img src="../../../assets/images/avaliacoes/avaliacao1/item06.png" alt="Descrição">

  <p class="table-source">Fonte: <a href="#1">(Barbosa et al., 2021, p. 100)</a></p>
</div>
...
<div align="center">
  <p class="table-source"><strong>Figura 7</strong> - Comprovação do Item 07</p>
  
  <img src="../../../assets/images/avaliacoes/avaliacao1/item07.png" alt="Descrição">

  <p class="table-source">Fonte: <a href="#1">(Barbosa et al., 2021, p. 251)</a></p>
</div>
...
<font size="3"><p class="table-source"><b>Tabela 3</b> - Avaliação</p></font>
...
| Desenvolvimento do Projeto | Vídeo de apresentação não está na categoria “não listado” no YouTube? | sim - [Apresentação da entrega 1 - Youtube](../../apresentacoes/entrega1.md) | 1.0 - 11/04/2026 - 10:10 |
| Desenvolvimento do Projeto | Há uma Tabela de Contribuições com o nome de todos os integrantes, a contribuição exata de cada um e a hiperligação para a respectiva atividade e gravação, se houver? | sim - [Tabela de Atividades Desenvolvidas](../../tabelasAtividades/entrega1.md) | 1.1 - 11/04/2026 - 11:25 |
...
<script>
  // Dados das respostas
  var data = [{
    values: [24, 4 ],  // 18 respostas "Sim" e 1 "Não"
    labels: ["Sim", "Não"],
    type: "pie",
    marker: {
  ...
  // Layout do gráfico
  var layout = {
    title: "Gráfico 1 - Relação de Itens de verificação antes da verificação",
    font: { size: 16 },
  };
...
<script>
  // Dados das respostas
  var data = [{
    values: [28, 0 ],  // 18 respostas "Sim" e 1 "Não"
    labels: ["Sim", "Não"],
    type: "pie",
    marker: {
      colors: ["#4CAF50", "#F44336", "#FF9800"]  // Verde para "Sim", Vermelho para "Não", Laranja para "Incompleto"
  ...
  // Layout do gráfico
  var layout = {
    title: "Gráfico 2 -Relação de Itens de verificação após a 1ª verificação",
    font: { size: 16 },
  };
...
## Referências Bibliográficas
 ...
 > <p id="1"> BARBOSA, Simone Diniz Junqueira et al. <b>Interação Humano-Computador e Experiência do Usuário</b>. 1. ed. Rio de Janeiro: Simone Diniz Junqueira Barbosa, 2021. E-book. </p>
 > <p id="2"> UNIVERSIDADE DE BRASÍLIA. Campus UnB Gama. **Plano de Ensino: Interação Humano Computador**. Professor: Dr. André Barros de Sales. Semestre 01/2026. Brasília, DF: UnB, 2026. Disponível em: <https://aprender3.unb.br/pluginfile.php/3335948/mod_resource/content/61/Plano_de_Ensino%20FIHC%20012026%20Turma%2003%20v2.pdf>. Acesso em: 11 abr. 2026.
