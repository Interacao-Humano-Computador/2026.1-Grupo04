...
| :---------------------------------------------------: | :-------------------: | :-------------------------------------------------------------------------------------------------------------------------------: |
|        ![Logo do GitHub](../assets/ferramentas/github.png)        |        GitHub         |        Hospedagem do código-fonte, controle de versão e publicação da documentação via GitHub Pages.<a id="anchor_1" href="#FRM1">1</a>        |
|       ![Logo do Telegram](../assets/ferramentas/telegram.png)       |       Telegram        | Canal secundário para comunicação rápida e troca de arquivos com a equipe e o docente.<a id="anchor_2" href="#FRM2">2</a> |
|         ![Logo do Meet](../assets/ferramentas/meet.png)         |         Google Meet         |              Realização de reuniões remotas, gravações de apresentações e chamadas de vídeo.<a id="3" href="#FRM3">3</a>               |
|          ![Logo do Miro](../assets/ferramentas/miro.png)          |         Miro          |         Colaboração visual para criação de mapas mentais, fluxogramas e brainstorms iniciais.<a id="anchor_4" href="#FRM4">4</a>         |
|         ![Logo do Figma](../assets/ferramentas/figma.png)         |         Figma         |          Desenho de interfaces, wireframes e prototipagem de alta fidelidade para IHC.<a id="anchor_3" href="#FRM3">5</a>           |
|        ![Logo do MkDocs](../assets/ferramentas/mkdocs.png)        |        MkDocs         |                Framework para geração de sites de documentação técnica estática.<a id="anchor_4" href="#FRM4">6</a>                 |
|        ![Logo do VSCode](../assets/ferramentas/vscode.png)        |  Visual Studio Code   |              Ambiente de desenvolvimento principal para edição dos arquivos Markdown e YAML.<a id="anchor_5" href="#FRM5">7</a>              |
|       ![Logo do WhatsApp](../assets/ferramentas/whatsapp.png)       |       WhatsApp        |              Principal meio de comunicação instantânea e coordenação de tarefas diárias.<a id="anchor_6" href="#FRM6">8</a>              |
|        ![Logo do YouTube](../assets/ferramentas/youtube.png)        |        YouTube        |                  Armazenamento e compartilhamento público dos vídeos e apresentações do grupo.<a id="anchor_7" href="#FRM7">9</a>                  |
